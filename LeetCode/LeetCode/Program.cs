...
//printTitle("Valid Palindrome ");
//Console.WriteLine(ValidPalindrome.IsPalindrome("race a caR"));
//Console.WriteLine(ValidPalindrome.IsPalindrome("A man, a pla1n, a can1al: Panama"));
//#endregion

#region Isomorphic Strings
printTitle("Isomorphic Strings ");
Console.WriteLine(IsomorphicStrings.IsIsomorphicStrings("egg", "add"));       // Output: True
Console.WriteLine(IsomorphicStrings.IsIsomorphicStrings("foo", "bar"));       // Output: False
Console.WriteLine(IsomorphicStrings.IsIsomorphicStrings("paper", "title"));
